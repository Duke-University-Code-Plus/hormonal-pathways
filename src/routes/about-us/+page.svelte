<script>
    ...
    <div class="flex flex-wrap justify-center m-5">
        <div class="m-5 p-5 border rounded shadow-lg"> 
            ...
            <img src="/AaronPic.png" alt="Photo of Aaron Kutnick, the Team Lead" class="rounded-full w-32 h-32 mx-auto">
        ...
        <div class="m-5 p-5 border rounded shadow-lg"> 
            <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src="/BillyPic.png" alt="Photo of Billy McCune" class="rounded-full w-32 h-32 mx-auto">
            <h4 class="text-center text-xl font-bold mt-4">Billy McCune</h4>
            <p class="text-center mt-2">"I'm on the cut" <br> Frat Lord</p>
        </div>
        <div class="m-5 p-5 border rounded shadow-lg">
            <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src="/BrandonPic.png" alt="Photo of Brandon Rivera" class="rounded-full w-32 h-32 mx-auto">
        ...
        <div class="m-5 p-5 border rounded shadow-lg"> 
            <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src="/HarutaPic.png" alt="Photo of Haruta Otaki" class="rounded-full w-32 h-32 mx-auto">
        ...
        <div class="m-5 p-5 border rounded shadow-lg">
             <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src="/KarismaPic.png" alt="Photo of Karisma Lavana" class="rounded-full w-32 h-32 mx-auto">
            <h4 class="text-center text-xl font-bold mt-4">Karisma Lavana</h4>
            <p class="text-center mt-2">pro speed walker <br> rizz lord</p>
        </div>
        <div class="m-5 p-5 border rounded shadow-lg"> 
            <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src="/NelsonPic.png" alt="Photo of Nelson Anderson" class="rounded-full w-32 h-32 mx-auto">
            <h4 class="text-center text-xl font-bold mt-4">Nelson Anderson</h4>
            <p class="text-center mt-2">Pepsi Goblin</p>
        </div>
        <div class="m-5 p-5 border rounded shadow-lg"> 
            <!-- svelte-ignore a11y-img-redundant-alt -->
            <img src="/VanessaPic.png" alt="Photo of Vanessa Lin" class="rounded-full w-32 h-32 mx-auto">
